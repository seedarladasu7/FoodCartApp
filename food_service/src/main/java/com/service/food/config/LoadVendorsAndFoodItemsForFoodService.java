...
import com.service.food.entity.Vendor;
import com.service.food.processor.ValidationFoodItemProcessor;

@Configuration
@EnableBatchProcessing
@EnableScheduling
public class LoadVendorsAndFoodItemsForFoodService {
	...
	private Job readCSVJob;
		...
		public Step readCSVFileStep() {
			return stepBuilderFactory.get("readCSVFileStep").<FoodItem, FoodItem>chunk(5).reader(readCSVFileReader()).processor(readCSVFileProcessor())
